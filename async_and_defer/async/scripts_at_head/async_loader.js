console.log('\n\n\n%c At the start of the asycn_loader.js, Will Add Tiger Image', 'color:blue');
...
try {
    ...
    console.log('%c DOMContentLoaded Dispatched Even Before async loader registers event for it, DOM was fully resolved even before asycn_loader.js is fetched', 'color:blue');
