...
describe('Creates Graph instance', function () {
    ...
    it('should add edges to unidirected graph', () => {
        const graph = new Graph();
        ...
        expect(graphVertexA).not.to.be.undefined;
        expect(graphVertexB).not.to.be.undefined;
    })
